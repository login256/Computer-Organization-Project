...
_main_handler:
	...
	nop
		...
		nop
			...
			bne $t1, $0, _handler_course_if_2_end
			nop
				...
				li $t2, 10
				bne $t1, $t2, _handler_course_if_4_end
				nop
					li $t1, 0
				_handler_course_if_4_end:
				...
				sltiu $t2, $t1, 3
				bne $t2, $0, _handler_course_if_3_end
				nop
					li $t1, 2
				_handler_course_if_3_end:

				li $t0, 0x500
				sw $t1, 0($t0)
					
			_handler_course_if_2_end:
			
			li $t0, 0x500
			lw $t1, 0($t0)
			bne $t1, $0, _handler_course_if_1_end
			nop
				li $t0, 0x7f38
				sw $0, 0($t0)
